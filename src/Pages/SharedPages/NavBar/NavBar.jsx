                ...
                {navItems.map((item, index) => (
                  <li key={index} className="menu-item flex-shrink-0">
                    <div className="h-20 flex-shrink-0 flex items-center">
                      <Link
                        to={item.to}
                        className="inline-flex items-center text-sm lg:text-[15px] font-medium text-slate-800 dark:text-slate-50 dark:hover:text-slate-800 py-2.5 px-4 xl:px-5 rounded-full hover:text-slate-900 hover:bg-slate-100 dark:hover:bg-slate-100"
                      >
                        {item.label}
                      </Link>
                    </div>
            ...
            <div className="lg:col-span-3 col-span-2 order-3 flex-1 flex items-center justify-end text-slate-700 dark:text-slate-50">
              ...
              <div className="AvatarDropdown ">
                <Link to="Authentication/Register">
                  <div className="relative">
                    <button
                      className="w-10 h-10 sm:w-12 sm:h-12 rounded-full text-slate-700 dark:text-slate-50 hover:bg-slate-100 dark:hover:bg-slate-800 dark:hover:text-slate-200 focus:outline-none flex items-center justify-center"
                      type="button"
                    >
              ...
              <div className="relative">
                <button
                  className="
                text-opacity-90
                 group w-10 h-10 sm:w-12 sm:h-12 hover:bg-slate-100 dark:text-slate-50 dark:hover:bg-slate-800 dark:hover:text-slate-200 rounded-full inline-flex items-center justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 relative"
                  type="button"
                >
